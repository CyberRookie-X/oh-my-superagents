...
| Host bootstrap | Native plugin entry | Local bootstrap/plugin bundle | None | None | Plugin manifest |
| Compatibility monitor | Full | Full | None yet | None yet | None yet |
| Generated host artifacts | Agents + commands | Agents + plugin/skills | Agents + commands | Skills | Agents + skills + plugin |
