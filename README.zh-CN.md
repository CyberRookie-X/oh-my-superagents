...
| 宿主引导/Bootstrap | 原生插件入口 | 本地 bootstrap / plugin bundle | 暂无 | 暂无 | 本地 bootstrap / plugin bundle |
| 上游兼容性监控 | 完整支持 | 完整支持 | 暂未实现 | 暂未实现 | 实验性支持 |
| 生成宿主工件 | Agents + Commands | Agents + Plugin/Skills | Agents + Commands | Skills | Agents + Plugin/Skills + Hooks |
